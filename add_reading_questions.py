...
GREAT_ESCAPE_PART1 = """The Great Escape
by Susan Mitsch

Part 1

The county was full of farms—farms here, farms there, farms everywhere. In the middle of the county fairgrounds sat the poultry tent. And in the middle of the poultry tent sat Rhode Island Red, the rooster.
...
The birds reached the goat barn. Soon Rhode Island Red had let every goat loose! Billies, nannies, and kids all joined in the party!
...
The sheep, cows, and goats followed the boy's trail of oats. The ponies jumped off the merry-go-round and sniffed after the sweet oats. The pigs followed, gobbling oats greedily. The chickens and geese pecked up oats, too. Rattle, rattle, shake-a-shake-a-shake!
...
UNDER_MY_NOSE_PART1 = """Excerpt from Under My Nose
by Lois Ehlert
...
I never planned to be a writer, but something happened that changed my mind. About ten years ago I took a course to learn how to make handmade books. The books I made needed text, so I began writing words to go with my art. About the same time, I had an idea for a story about my garden.
...
④
Getting a good idea for a book is the hardest thing for me, but also the most fun. Watching Milwaukee's annual circus parade with its flashy colors and interesting animals inspired the idea for my book Circus.
...
⑥
When I write my books, I start with the picture first. Bucky, my sister's cat, was my model for Feathers for Lunch. Before I wrote the story I measured his legs, his head, and his tail, and painted a life-size portrait of him. The story is about a cat trying to catch a bird. That's why I put the bell on his collar—it warns the birds. I added the words "jingle, jingle" to go with my art.

I began writing the story from the cat's viewpoint. Later, I rewrote it from the cat owner's viewpoint.

Even when I get an idea for a book, it's difficult for me to get started.
...
GRANDFATHER_FROG_PART1 = """Adapted from The Adventures of Grandfather Frog: 'Billy Mink Finds Little Joe Otter'
...
⑤
They first gather together a number of sticks and logs about five feet long, which they carry or roll into the stream. While some of the beavers are doing this—for the safety of the village lies in the strength of the foundation^2—others are gathering and piling up many green branches of trees. These branches, which they have cut from the trees with their teeth, are piled among the sticks and logs, and soon a dam is formed that reaches across the stream.
...
^1 rudder: a tool used as a guide
^2 foundation: the lowest level when building"""

DOG_HERO_PART1 = """Excerpt from "Dog a Hero on Mount Hood"
by Susan Jankowski
...
GRADE_3_READING_QUESTIONS = [
    ...
    },
    {
        ...
        "correct_answer": "Both calmed the climbers.",
        "explanation": "Both actions helped comfort and calm the climbers during the cold, dangerous situation on the mountain."
    },
